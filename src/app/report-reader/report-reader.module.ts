...
import {FilterComponent} from './identity/filter.component';
...
//	EffectsModule.run(myReportEffects),
   ...
   bootstrap: [
    IdentityComponent,DynamicFormComponent,FilterComponent
  ],
  exports: [    
...
FilterComponent	
  ...
  entryComponents :[CertificationComponent,DynamicFormComponent,FilterComponent]
})
